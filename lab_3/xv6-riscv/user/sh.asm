...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	39e58593          	addi	a1,a1,926 # 13b0 <lock_release+0x18>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	35858593          	addi	a1,a1,856 # 13b8 <lock_release+0x20>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	32650513          	addi	a0,a0,806 # 13c0 <lock_release+0x28>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	3fa70713          	addi	a4,a4,1018 # 14c0 <lock_release+0x128>
    ...
    panic("runcmd");
      ...
      e4:	2e850513          	addi	a0,a0,744 # 13c8 <lock_release+0x30>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	2ce58593          	addi	a1,a1,718 # 13d0 <lock_release+0x38>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	29258593          	addi	a1,a1,658 # 13e0 <lock_release+0x48>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	20c50513          	addi	a0,a0,524 # 13f0 <lock_release+0x58>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b0:	e6cb8b93          	addi	s7,s7,-404 # 1418 <lock_release+0x80>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c2:	e3a50513          	addi	a0,a0,-454 # 13f8 <lock_release+0x60>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	d7a60613          	addi	a2,a2,-646 # 1420 <lock_release+0x88>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6da:	d6ab0b13          	addi	s6,s6,-662 # 1440 <lock_release+0xa8>
  ...
  return ret;
     ...
     714:	d1850513          	addi	a0,a0,-744 # 1428 <lock_release+0x90>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     776:	cbe50513          	addi	a0,a0,-834 # 1430 <lock_release+0x98>
...
0000000000000790 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b0:	c9c60613          	addi	a2,a2,-868 # 1448 <lock_release+0xb0>
     7b4:	85ce                	mv	a1,s3
     7b6:	854a                	mv	a0,s2
...
00000000000007fe <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     820:	c34a0a13          	addi	s4,s4,-972 # 1450 <lock_release+0xb8>
  ...
  if(peek(ps, es, ";")){
     ...
     856:	c0660613          	addi	a2,a2,-1018 # 1458 <lock_release+0xc0>
     85a:	85ce                	mv	a1,s3
     85c:	854a                	mv	a0,s2
...
00000000000008a6 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8bc:	b6860613          	addi	a2,a2,-1176 # 1420 <lock_release+0x88>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ec:	b8860613          	addi	a2,a2,-1144 # 1470 <lock_release+0xd8>
     8f0:	85ca                	mv	a1,s2
     8f2:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92e:	b3650513          	addi	a0,a0,-1226 # 1460 <lock_release+0xc8>
     932:	fffff097          	auipc	ra,0xfffff
     936:	724080e7          	jalr	1828(ra) # 56 <panic>
    panic("syntax - missing )");
     93a:	00001517          	auipc	a0,0x1
     93e:	b3e50513          	addi	a0,a0,-1218 # 1478 <lock_release+0xe0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96a:	b7270713          	addi	a4,a4,-1166 # 14d8 <lock_release+0x140>
...
00000000000009e2 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a16:	a7e60613          	addi	a2,a2,-1410 # 1490 <lock_release+0xf8>
     a1a:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4c:	a5058593          	addi	a1,a1,-1456 # 1498 <lock_release+0x100>
     a50:	4509                	li	a0,2
     a52:	00000097          	auipc	ra,0x0
     a56:	70e080e7          	jalr	1806(ra) # 1160 <fprintf>
    panic("syntax");
     a5a:	00001517          	auipc	a0,0x1
     a5e:	9ce50513          	addi	a0,a0,-1586 # 1428 <lock_release+0x90>
...
0000000000000a6a <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	a2c48493          	addi	s1,s1,-1492 # 14a8 <lock_release+0x110>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     abe:	9f6a8a93          	addi	s5,s5,-1546 # 14b0 <lock_release+0x118>
...
0000000000000e9c <sched_tickets>:
...
0000000000000ea4 <sched_statistics>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     efc:	65850513          	addi	a0,a0,1624 # 1550 <digits>
     f00:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     fbc:	540c8c93          	addi	s9,s9,1344 # 14f8 <lock_release+0x160>
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fca:	58ab8b93          	addi	s7,s7,1418 # 1550 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10f0:	40498993          	addi	s3,s3,1028 # 14f0 <lock_release+0x158>
        while(*s != 0){
    10f4:	85ee                	mv	a1,s11
...
000000000000132c <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
    ...
    1332:	e426                	sd	s1,8(sp)
    1334:	e04a                	sd	s2,0(sp)
    1336:	1000                	addi	s0,sp,32
    1338:	84aa                	mv	s1,a0
    133a:	892e                	mv	s2,a1
    int pg_size = 4096*sizeof(void);
    void* stack = (void*)malloc(pg_size);
    133c:	6505                	lui	a0,0x1
    133e:	00000097          	auipc	ra,0x0
    1342:	f08080e7          	jalr	-248(ra) # 1246 <malloc>
    int t_id = clone(stack);
    1346:	00000097          	auipc	ra,0x0
    134a:	b66080e7          	jalr	-1178(ra) # eac <clone>
    if(t_id==0) {
    134e:	c901                	beqz	a0,135e <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
    ...
    1356:	64a2                	ld	s1,8(sp)
    1358:	6902                	ld	s2,0(sp)
    135a:	6105                	addi	sp,sp,32
    135c:	8082                	ret
        (*start_routine)(arg);
    135e:	854a                	mv	a0,s2
    1360:	9482                	jalr	s1
    ...
    1368:	a80080e7          	jalr	-1408(ra) # de4 <exit>

000000000000136c <lock_init>:
...
lock_init(struct lock_t *lock)
{
    ...
    lock->locked = 0;
    1372:	00052023          	sw	zero,0(a0) # 1000 <vprintf+0x7e>
}
    1376:	6422                	ld	s0,8(sp)
    1378:	0141                	addi	sp,sp,16
    137a:	8082                	ret

000000000000137c <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
    ...
    1382:	4705                	li	a4,1
    1384:	87ba                	mv	a5,a4
    1386:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    138a:	2781                	sext.w	a5,a5
    138c:	ffe5                	bnez	a5,1384 <lock_acquire+0x8>
    __sync_synchronize();
    138e:	0ff0000f          	fence
}
...
lock_release(struct lock_t *lock)
{
    ...
    13a2:	0f50000f          	fence	iorw,ow
    13a6:	0805202f          	amoswap.w	zero,zero,(a0)
}
    13aa:	6422                	ld	s0,8(sp)
    13ac:	0141                	addi	sp,sp,16
    13ae:	8082                	ret
