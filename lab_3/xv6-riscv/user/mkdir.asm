...
main(int argc, char *argv[])
{
  ...
  42:	89258593          	addi	a1,a1,-1902 # 8d0 <lock_release+0x1e>
  46:	4509                	li	a0,2
  ...
  60:	88c58593          	addi	a1,a1,-1908 # 8e8 <lock_release+0x36>
  64:	4509                	li	a0,2
...
00000000000003b6 <sched_tickets>:
...
00000000000003be <sched_statistics>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 416:	55650513          	addi	a0,a0,1366 # 968 <digits>
 41a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d6:	43ec8c93          	addi	s9,s9,1086 # 910 <lock_release+0x5e>
 ...
 4e4:	488b8b93          	addi	s7,s7,1160 # 968 <digits>
 ...
 60a:	30298993          	addi	s3,s3,770 # 908 <lock_release+0x56>
        while(*s != 0){
 60e:	85ee                	mv	a1,s11
...
0000000000000846 <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 85c:	f08080e7          	jalr	-248(ra) # 760 <malloc>
    int t_id = clone(stack);
 860:	00000097          	auipc	ra,0x0
 864:	b66080e7          	jalr	-1178(ra) # 3c6 <clone>
    if(t_id==0) {
 868:	c901                	beqz	a0,878 <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 882:	a80080e7          	jalr	-1408(ra) # 2fe <exit>

0000000000000886 <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 88a:	0800                	addi	s0,sp,16
    lock->locked = 0;
 88c:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 890:	6422                	ld	s0,8(sp)
 892:	0141                	addi	sp,sp,16
 894:	8082                	ret

0000000000000896 <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 89c:	4705                	li	a4,1
 89e:	87ba                	mv	a5,a4
 8a0:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 8a4:	2781                	sext.w	a5,a5
 8a6:	ffe5                	bnez	a5,89e <lock_acquire+0x8>
    __sync_synchronize();
 8a8:	0ff0000f          	fence
}
 8ac:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 8bc:	0f50000f          	fence	iorw,ow
 8c0:	0805202f          	amoswap.w	zero,zero,(a0)
}
 8c4:	6422                	ld	s0,8(sp)
