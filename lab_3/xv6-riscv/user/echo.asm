...
main(int argc, char *argv[])
{
  ...
  2e:	8b6a0a13          	addi	s4,s4,-1866 # 8e0 <lock_release+0x22>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	88058593          	addi	a1,a1,-1920 # 8e8 <lock_release+0x2a>
  70:	4505                	li	a0,1
...
00000000000003c2 <sched_tickets>:
...
00000000000003ca <sched_statistics>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e2:	41ac8c93          	addi	s9,s9,1050 # 8f8 <lock_release+0x3a>
 ...
 4f0:	464b8b93          	addi	s7,s7,1124 # 950 <digits>
 ...
 616:	2de98993          	addi	s3,s3,734 # 8f0 <lock_release+0x32>
        while(*s != 0){
 61a:	85ee                	mv	a1,s11
...
0000000000000852 <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 868:	f08080e7          	jalr	-248(ra) # 76c <malloc>
    int t_id = clone(stack);
 86c:	00000097          	auipc	ra,0x0
 870:	b66080e7          	jalr	-1178(ra) # 3d2 <clone>
    if(t_id==0) {
 874:	c901                	beqz	a0,884 <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 88e:	a80080e7          	jalr	-1408(ra) # 30a <exit>

0000000000000892 <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 896:	0800                	addi	s0,sp,16
    lock->locked = 0;
 898:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 89c:	6422                	ld	s0,8(sp)
 89e:	0141                	addi	sp,sp,16
 8a0:	8082                	ret

00000000000008a2 <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 8a8:	4705                	li	a4,1
 8aa:	87ba                	mv	a5,a4
 8ac:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 8b0:	2781                	sext.w	a5,a5
 8b2:	ffe5                	bnez	a5,8aa <lock_acquire+0x8>
    __sync_synchronize();
 8b4:	0ff0000f          	fence
}
 8b8:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 8c8:	0f50000f          	fence	iorw,ow
 8cc:	0805202f          	amoswap.w	zero,zero,(a0)
}
 8d0:	6422                	ld	s0,8(sp)
