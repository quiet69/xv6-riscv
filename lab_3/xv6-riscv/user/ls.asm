...
ls(char *path)
{
 ...
 12c:	a3850513          	addi	a0,a0,-1480 # b60 <lock_release+0x50>
 ...
 16a:	9ca58593          	addi	a1,a1,-1590 # b30 <lock_release+0x20>
 16e:	4509                	li	a0,2
 ...
 180:	9cc58593          	addi	a1,a1,-1588 # b48 <lock_release+0x38>
 184:	4509                	li	a0,2
 ...
 1b2:	9c250513          	addi	a0,a0,-1598 # b70 <lock_release+0x60>
 ...
 1f6:	996a0a13          	addi	s4,s4,-1642 # b88 <lock_release+0x78>
        printf("ls: cannot stat %s\n", buf);
 1fa:	00001a97          	auipc	s5,0x1
 1fe:	94ea8a93          	addi	s5,s5,-1714 # b48 <lock_release+0x38>
...
main(int argc, char *argv[])
{
 ...
 2c0:	8dc50513          	addi	a0,a0,-1828 # b98 <lock_release+0x88>
...
0000000000000614 <sched_tickets>:
...
000000000000061c <sched_statistics>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 674:	59050513          	addi	a0,a0,1424 # c00 <digits>
 678:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 734:	478c8c93          	addi	s9,s9,1144 # ba8 <lock_release+0x98>
 ...
 742:	4c2b8b93          	addi	s7,s7,1218 # c00 <digits>
 ...
 868:	33c98993          	addi	s3,s3,828 # ba0 <lock_release+0x90>
        while(*s != 0){
 86c:	85ee                	mv	a1,s11
...
0000000000000aa4 <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 aba:	f08080e7          	jalr	-248(ra) # 9be <malloc>
    int t_id = clone(stack);
 abe:	00000097          	auipc	ra,0x0
 ac2:	b66080e7          	jalr	-1178(ra) # 624 <clone>
    if(t_id==0) {
 ac6:	c901                	beqz	a0,ad6 <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 ae0:	a80080e7          	jalr	-1408(ra) # 55c <exit>

0000000000000ae4 <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 ae8:	0800                	addi	s0,sp,16
    lock->locked = 0;
 aea:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 aee:	6422                	ld	s0,8(sp)
 af0:	0141                	addi	sp,sp,16
 af2:	8082                	ret

0000000000000af4 <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 afa:	4705                	li	a4,1
 afc:	87ba                	mv	a5,a4
 afe:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 b02:	2781                	sext.w	a5,a5
 b04:	ffe5                	bnez	a5,afc <lock_acquire+0x8>
    __sync_synchronize();
 b06:	0ff0000f          	fence
}
 b0a:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 b1a:	0f50000f          	fence	iorw,ow
 b1e:	0805202f          	amoswap.w	zero,zero,(a0)
}
 b22:	6422                	ld	s0,8(sp)
