...
main(int argc, char *argv[])
{
  ...
  14:	8b058593          	addi	a1,a1,-1872 # 8c0 <lock_release+0x26>
  18:	4509                	li	a0,2
  ...
  50:	88c58593          	addi	a1,a1,-1908 # 8d8 <lock_release+0x3e>
  54:	4509                	li	a0,2
...
000000000000039e <sched_tickets>:
...
00000000000003a6 <sched_statistics>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4be:	43ec8c93          	addi	s9,s9,1086 # 8f8 <lock_release+0x5e>
 ...
 4cc:	488b8b93          	addi	s7,s7,1160 # 950 <digits>
 ...
 5f2:	30298993          	addi	s3,s3,770 # 8f0 <lock_release+0x56>
        while(*s != 0){
 5f6:	85ee                	mv	a1,s11
...
000000000000082e <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 844:	f08080e7          	jalr	-248(ra) # 748 <malloc>
    int t_id = clone(stack);
 848:	00000097          	auipc	ra,0x0
 84c:	b66080e7          	jalr	-1178(ra) # 3ae <clone>
    if(t_id==0) {
 850:	c901                	beqz	a0,860 <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 86a:	a80080e7          	jalr	-1408(ra) # 2e6 <exit>

000000000000086e <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 872:	0800                	addi	s0,sp,16
    lock->locked = 0;
 874:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 878:	6422                	ld	s0,8(sp)
 87a:	0141                	addi	sp,sp,16
 87c:	8082                	ret

000000000000087e <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 884:	4705                	li	a4,1
 886:	87ba                	mv	a5,a4
 888:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 88c:	2781                	sext.w	a5,a5
 88e:	ffe5                	bnez	a5,886 <lock_acquire+0x8>
    __sync_synchronize();
 890:	0ff0000f          	fence
}
 894:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 8a4:	0f50000f          	fence	iorw,ow
 8a8:	0805202f          	amoswap.w	zero,zero,(a0)
}
 8ac:	6422                	ld	s0,8(sp)
