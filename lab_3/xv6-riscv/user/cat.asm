...
cat(int fd)
{
  ...
  44:	93058593          	addi	a1,a1,-1744 # 970 <lock_release+0x18>
  48:	4509                	li	a0,2
  ...
  72:	91a58593          	addi	a1,a1,-1766 # 988 <lock_release+0x30>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	89e58593          	addi	a1,a1,-1890 # 9a0 <lock_release+0x48>
 10a:	4509                	li	a0,2
...
000000000000045c <sched_tickets>:
...
0000000000000464 <sched_statistics>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4bc:	56050513          	addi	a0,a0,1376 # a18 <digits>
 4c0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 57c:	448c8c93          	addi	s9,s9,1096 # 9c0 <lock_release+0x68>
 ...
 58a:	492b8b93          	addi	s7,s7,1170 # a18 <digits>
 ...
 6b0:	30c98993          	addi	s3,s3,780 # 9b8 <lock_release+0x60>
        while(*s != 0){
 6b4:	85ee                	mv	a1,s11
...
00000000000008ec <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 902:	f08080e7          	jalr	-248(ra) # 806 <malloc>
    int t_id = clone(stack);
 906:	00000097          	auipc	ra,0x0
 90a:	b66080e7          	jalr	-1178(ra) # 46c <clone>
    if(t_id==0) {
 90e:	c901                	beqz	a0,91e <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 928:	a80080e7          	jalr	-1408(ra) # 3a4 <exit>

000000000000092c <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 930:	0800                	addi	s0,sp,16
    lock->locked = 0;
 932:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 936:	6422                	ld	s0,8(sp)
 938:	0141                	addi	sp,sp,16
 93a:	8082                	ret

000000000000093c <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 942:	4705                	li	a4,1
 944:	87ba                	mv	a5,a4
 946:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 94a:	2781                	sext.w	a5,a5
 94c:	ffe5                	bnez	a5,944 <lock_acquire+0x8>
    __sync_synchronize();
 94e:	0ff0000f          	fence
}
 952:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 962:	0f50000f          	fence	iorw,ow
 966:	0805202f          	amoswap.w	zero,zero,(a0)
}
 96a:	6422                	ld	s0,8(sp)
