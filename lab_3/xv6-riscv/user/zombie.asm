...
0000000000000368 <sched_tickets>:
...
0000000000000370 <sched_statistics>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 488:	404c8c93          	addi	s9,s9,1028 # 888 <lock_release+0x24>
 ...
 5bc:	2c898993          	addi	s3,s3,712 # 880 <lock_release+0x1c>
        while(*s != 0){
 5c0:	85ee                	mv	a1,s11
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 816:	b66080e7          	jalr	-1178(ra) # 378 <clone>
    if(t_id==0) {
 ...
 834:	a80080e7          	jalr	-1408(ra) # 2b0 <exit>
