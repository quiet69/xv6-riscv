...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	15250513          	addi	a0,a0,338 # 6190 <lock_release+0x1c>
      ...
      74:	8082                	ret
{
      ...
      84:	13050513          	addi	a0,a0,304 # 61b0 <lock_release+0x3c>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	12050513          	addi	a0,a0,288 # 61c8 <lock_release+0x54>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	12250513          	addi	a0,a0,290 # 61e8 <lock_release+0x74>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	0ea50513          	addi	a0,a0,234 # 61d0 <lock_release+0x5c>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0f650513          	addi	a0,a0,246 # 61f8 <lock_release+0x84>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0f450513          	addi	a0,a0,244 # 6220 <lock_release+0xac>
     134:	00006097          	auipc	ra,0x6
     138:	adc080e7          	jalr	-1316(ra) # 5c10 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	0e050513          	addi	a0,a0,224 # 6220 <lock_release+0xac>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	0dc58593          	addi	a1,a1,220 # 6230 <lock_release+0xbc>
     15c:	00006097          	auipc	ra,0x6
     160:	a84080e7          	jalr	-1404(ra) # 5be0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	0b850513          	addi	a0,a0,184 # 6220 <lock_release+0xac>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	0bc58593          	addi	a1,a1,188 # 6238 <lock_release+0xc4>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	08c50513          	addi	a0,a0,140 # 6220 <lock_release+0xac>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	07650513          	addi	a0,a0,118 # 6240 <lock_release+0xcc>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	fec50513          	addi	a0,a0,-20 # 6268 <lock_release+0xf4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	fd8a8a93          	addi	s5,s5,-40 # 6268 <lock_release+0xf4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f6650513          	addi	a0,a0,-154 # 6278 <lock_release+0x104>
     ...
     338:	f6450513          	addi	a0,a0,-156 # 6298 <lock_release+0x124>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	f5250513          	addi	a0,a0,-174 # 62b0 <lock_release+0x13c>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	f3e98993          	addi	s3,s3,-194 # 62b0 <lock_release+0x13c>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	ef250513          	addi	a0,a0,-270 # 62b0 <lock_release+0x13c>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	e6258593          	addi	a1,a1,-414 # 6238 <lock_release+0xc4>
    ...
    printf("write failed\n");
     ...
     3f0:	ee450513          	addi	a0,a0,-284 # 62d0 <lock_release+0x15c>
    ...
    exit(1);
     ...
     40a:	eb250513          	addi	a0,a0,-334 # 62b8 <lock_release+0x144>
    ...
    printf("open junk failed\n");
     ...
     424:	e9850513          	addi	a0,a0,-360 # 62b8 <lock_release+0x144>
  ...
  unlink("junk");
     ...
     448:	e6c50513          	addi	a0,a0,-404 # 62b0 <lock_release+0x13c>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d90a0a13          	addi	s4,s4,-624 # 62e0 <lock_release+0x16c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	cec50513          	addi	a0,a0,-788 # 62e8 <lock_release+0x174>
     ...
     61e:	ce650513          	addi	a0,a0,-794 # 6300 <lock_release+0x18c>
     ...
     63c:	cf850513          	addi	a0,a0,-776 # 6330 <lock_release+0x1bc>
     ...
     656:	d0e50513          	addi	a0,a0,-754 # 6360 <lock_release+0x1ec>
     ...
     674:	d0050513          	addi	a0,a0,-768 # 6370 <lock_release+0x1fc>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	cf2a0a13          	addi	s4,s4,-782 # 63a0 <lock_release+0x22c>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b82a8a93          	addi	s5,s5,-1150 # 6238 <lock_release+0xc4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	c4c50513          	addi	a0,a0,-948 # 63a8 <lock_release+0x234>
     ...
     77e:	c4650513          	addi	a0,a0,-954 # 63c0 <lock_release+0x24c>
     ...
     798:	bcc50513          	addi	a0,a0,-1076 # 6360 <lock_release+0x1ec>
     ...
     7b2:	c4250513          	addi	a0,a0,-958 # 63f0 <lock_release+0x27c>
     ...
     7d0:	c3c50513          	addi	a0,a0,-964 # 6408 <lock_release+0x294>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	a0e58593          	addi	a1,a1,-1522 # 6230 <lock_release+0xbc>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	9e250513          	addi	a0,a0,-1566 # 6220 <lock_release+0xac>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	9b650513          	addi	a0,a0,-1610 # 6220 <lock_release+0xac>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	9a250513          	addi	a0,a0,-1630 # 6220 <lock_release+0xac>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	bdc58593          	addi	a1,a1,-1060 # 6498 <lock_release+0x324>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	92250513          	addi	a0,a0,-1758 # 6220 <lock_release+0xac>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	af650513          	addi	a0,a0,-1290 # 6438 <lock_release+0x2c4>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	afa50513          	addi	a0,a0,-1286 # 6458 <lock_release+0x2e4>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	af650513          	addi	a0,a0,-1290 # 6468 <lock_release+0x2f4>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	afa50513          	addi	a0,a0,-1286 # 6488 <lock_release+0x314>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	ac650513          	addi	a0,a0,-1338 # 6468 <lock_release+0x2f4>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	ae050513          	addi	a0,a0,-1312 # 64a0 <lock_release+0x32c>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	ae250513          	addi	a0,a0,-1310 # 64c0 <lock_release+0x34c>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	ace50513          	addi	a0,a0,-1330 # 64e0 <lock_release+0x36c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	ade98993          	addi	s3,s3,-1314 # 6508 <lock_release+0x394>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	b0ea8a93          	addi	s5,s5,-1266 # 6540 <lock_release+0x3cc>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	a6850513          	addi	a0,a0,-1432 # 64e0 <lock_release+0x36c>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	a2c50513          	addi	a0,a0,-1492 # 64e0 <lock_release+0x36c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	a0a50513          	addi	a0,a0,-1526 # 64e8 <lock_release+0x374>
    ...
    exit(1);
     ...
     b00:	a1c50513          	addi	a0,a0,-1508 # 6518 <lock_release+0x3a4>
     ...
     b1e:	a3650513          	addi	a0,a0,-1482 # 6550 <lock_release+0x3dc>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	a4250513          	addi	a0,a0,-1470 # 6578 <lock_release+0x404>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	a4650513          	addi	a0,a0,-1466 # 6598 <lock_release+0x424>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	a4250513          	addi	a0,a0,-1470 # 65b0 <lock_release+0x43c>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	a3050513          	addi	a0,a0,-1488 # 65d0 <lock_release+0x45c>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	9de50513          	addi	a0,a0,-1570 # 65d0 <lock_release+0x45c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	99e50513          	addi	a0,a0,-1634 # 65d8 <lock_release+0x464>
    ...
    exit(1);
     ...
     c5c:	9a050513          	addi	a0,a0,-1632 # 65f8 <lock_release+0x484>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	9ac50513          	addi	a0,a0,-1620 # 6620 <lock_release+0x4ac>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	93050513          	addi	a0,a0,-1744 # 65d0 <lock_release+0x45c>
     ...
     cd0:	97450513          	addi	a0,a0,-1676 # 6640 <lock_release+0x4cc>
     ...
     cee:	97e50513          	addi	a0,a0,-1666 # 6668 <lock_release+0x4f4>
     ...
     d0c:	97850513          	addi	a0,a0,-1672 # 6680 <lock_release+0x50c>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	98450513          	addi	a0,a0,-1660 # 66a8 <lock_release+0x534>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	96e50513          	addi	a0,a0,-1682 # 66c0 <lock_release+0x54c>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	98658593          	addi	a1,a1,-1658 # 66f0 <lock_release+0x57c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	93a50513          	addi	a0,a0,-1734 # 66c0 <lock_release+0x54c>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	92450513          	addi	a0,a0,-1756 # 66c0 <lock_release+0x54c>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	90e50513          	addi	a0,a0,-1778 # 66c0 <lock_release+0x54c>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	97258593          	addi	a1,a1,-1678 # 6738 <lock_release+0x5c4>
  ...
  unlink("unlinkread");
     ...
     e32:	89250513          	addi	a0,a0,-1902 # 66c0 <lock_release+0x54c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	88250513          	addi	a0,a0,-1918 # 66d0 <lock_release+0x55c>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	88e50513          	addi	a0,a0,-1906 # 66f8 <lock_release+0x584>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	89250513          	addi	a0,a0,-1902 # 6718 <lock_release+0x5a4>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	89e50513          	addi	a0,a0,-1890 # 6740 <lock_release+0x5cc>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	8a250513          	addi	a0,a0,-1886 # 6760 <lock_release+0x5ec>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	8a650513          	addi	a0,a0,-1882 # 6780 <lock_release+0x60c>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	7b258593          	addi	a1,a1,1970 # 66f0 <lock_release+0x57c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	84a58593          	addi	a1,a1,-1974 # 67a8 <lock_release+0x634>
     f66:	00006517          	auipc	a0,0x6
     f6a:	83a50513          	addi	a0,a0,-1990 # 67a0 <lock_release+0x62c>
  ...
  unlink("lf1");
     ...
     f7e:	82650513          	addi	a0,a0,-2010 # 67a0 <lock_release+0x62c>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00006517          	auipc	a0,0x6
     f90:	81450513          	addi	a0,a0,-2028 # 67a0 <lock_release+0x62c>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	80650513          	addi	a0,a0,-2042 # 67a8 <lock_release+0x634>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	7ce58593          	addi	a1,a1,1998 # 67a8 <lock_release+0x634>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	7b850513          	addi	a0,a0,1976 # 67a8 <lock_release+0x634>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	7a058593          	addi	a1,a1,1952 # 67a0 <lock_release+0x62c>
    1008:	00005517          	auipc	a0,0x5
    100c:	7a050513          	addi	a0,a0,1952 # 67a8 <lock_release+0x634>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	78458593          	addi	a1,a1,1924 # 67a0 <lock_release+0x62c>
    1024:	00006517          	auipc	a0,0x6
    1028:	88c50513          	addi	a0,a0,-1908 # 68b0 <lock_release+0x73c>
    ...
    104a:	76a50513          	addi	a0,a0,1898 # 67b0 <lock_release+0x63c>
    ...
    1066:	76650513          	addi	a0,a0,1894 # 67c8 <lock_release+0x654>
    ...
    1082:	76250513          	addi	a0,a0,1890 # 67e0 <lock_release+0x66c>
    ...
    109e:	76650513          	addi	a0,a0,1894 # 6800 <lock_release+0x68c>
    ...
    10ba:	77a50513          	addi	a0,a0,1914 # 6830 <lock_release+0x6bc>
    ...
    10d6:	77650513          	addi	a0,a0,1910 # 6848 <lock_release+0x6d4>
    ...
    10f2:	77250513          	addi	a0,a0,1906 # 6860 <lock_release+0x6ec>
    ...
    110e:	77e50513          	addi	a0,a0,1918 # 6888 <lock_release+0x714>
    ...
    112a:	79250513          	addi	a0,a0,1938 # 68b8 <lock_release+0x744>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	78098993          	addi	s3,s3,1920 # 68d8 <lock_release+0x764>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	75450513          	addi	a0,a0,1876 # 68e8 <lock_release+0x774>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	70ea0a13          	addi	s4,s4,1806 # 6908 <lock_release+0x794>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	6bc50513          	addi	a0,a0,1724 # 6908 <lock_release+0x794>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	65450513          	addi	a0,a0,1620 # 6910 <lock_release+0x79c>
    ...
    12e0:	65450513          	addi	a0,a0,1620 # 6930 <lock_release+0x7bc>
    ...
    12fc:	65850513          	addi	a0,a0,1624 # 6950 <lock_release+0x7dc>
...
000000000000134a <badarg>:
{
    ...
    1368:	e6498993          	addi	s3,s3,-412 # 61c8 <lock_release+0x54>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	7ba78793          	addi	a5,a5,1978 # 7ba8 <lock_release+0x1a34>
  ...
  if(pid == 0){
    ...
    144e:	19e78793          	addi	a5,a5,414 # 85e8 <lock_release+0x2474>
    ...
    1472:	d5a50513          	addi	a0,a0,-678 # 61c8 <lock_release+0x54>
    ...
    148a:	57250513          	addi	a0,a0,1394 # 69f8 <lock_release+0x884>
    ...
    14aa:	4ca50513          	addi	a0,a0,1226 # 6970 <lock_release+0x7fc>
    ...
    14ca:	4ca50513          	addi	a0,a0,1226 # 6990 <lock_release+0x81c>
    ...
    14ec:	4c850513          	addi	a0,a0,1224 # 69b0 <lock_release+0x83c>
    ...
    150c:	4d050513          	addi	a0,a0,1232 # 69d8 <lock_release+0x864>
    ...
    1526:	93650513          	addi	a0,a0,-1738 # 6e58 <lock_release+0xce4>
  ...
  if(st != 747){
    ...
    1570:	4b450513          	addi	a0,a0,1204 # 6a20 <lock_release+0x8ac>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	c8250513          	addi	a0,a0,-894 # 6220 <lock_release+0xac>
  ...
  if(pid == 0){
    ...
    15cc:	c58a0a13          	addi	s4,s4,-936 # 6220 <lock_release+0xac>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	4b0a8a93          	addi	s5,s5,1200 # 6a80 <lock_release+0x90c>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	41050513          	addi	a0,a0,1040 # 6a50 <lock_release+0x8dc>
    ...
    1660:	40c50513          	addi	a0,a0,1036 # 6a68 <lock_release+0x8f4>
    ...
    167e:	41650513          	addi	a0,a0,1046 # 6a90 <lock_release+0x91c>
    ...
    169c:	b88a0a13          	addi	s4,s4,-1144 # 6220 <lock_release+0xac>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	410a8a93          	addi	s5,s5,1040 # 6ab0 <lock_release+0x93c>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	b3650513          	addi	a0,a0,-1226 # 6220 <lock_release+0xac>
  ...
  exit(xstatus);
    ...
    170c:	36050513          	addi	a0,a0,864 # 6a68 <lock_release+0x8f4>
    ...
    172a:	39250513          	addi	a0,a0,914 # 6ab8 <lock_release+0x944>
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	a7a78793          	addi	a5,a5,-1414 # 61c8 <lock_release+0x54>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	37e78793          	addi	a5,a5,894 # 6ad8 <lock_release+0x964>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	37650513          	addi	a0,a0,886 # 6ae0 <lock_release+0x96c>
  ...
  if(pid == 0) {
    ...
    179c:	34850513          	addi	a0,a0,840 # 6ae0 <lock_release+0x96c>
    ...
    17b8:	34c50513          	addi	a0,a0,844 # 6b00 <lock_release+0x98c>
    ...
    17d4:	28050513          	addi	a0,a0,640 # 6a50 <lock_release+0x8dc>
    ...
    17f0:	2fc50513          	addi	a0,a0,764 # 6ae8 <lock_release+0x974>
    ...
    180e:	9be50513          	addi	a0,a0,-1602 # 61c8 <lock_release+0x54>
  ...
  if(xstatus != 0)
    ...
    1842:	2d250513          	addi	a0,a0,722 # 6b10 <lock_release+0x99c>
    ...
    185e:	2ce50513          	addi	a0,a0,718 # 6b28 <lock_release+0x9b4>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1872:	27250513          	addi	a0,a0,626 # 6ae0 <lock_release+0x96c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	d0050513          	addi	a0,a0,-768 # 6598 <lock_release+0x424>
    ...
    18b8:	1b450513          	addi	a0,a0,436 # 6a68 <lock_release+0x8f4>
  ...
  unlink("echo-ok");
    ...
    18d2:	21250513          	addi	a0,a0,530 # 6ae0 <lock_release+0x96c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	24850513          	addi	a0,a0,584 # 6b40 <lock_release+0x9cc>
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	1a050513          	addi	a0,a0,416 # 6b58 <lock_release+0x9e4>
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	13250513          	addi	a0,a0,306 # 6b70 <lock_release+0x9fc>
    ...
    1a5e:	12e50513          	addi	a0,a0,302 # 6b88 <lock_release+0xa14>
    ...
    1a90:	11450513          	addi	a0,a0,276 # 6ba0 <lock_release+0xa2c>
    ...
    1ad0:	0f450513          	addi	a0,a0,244 # 6bc0 <lock_release+0xa4c>
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	f1250513          	addi	a0,a0,-238 # 6a50 <lock_release+0x8dc>
    ...
    1b5e:	07e50513          	addi	a0,a0,126 # 6bd8 <lock_release+0xa64>
    ...
    1b7a:	07a50513          	addi	a0,a0,122 # 6bf0 <lock_release+0xa7c>
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	e6250513          	addi	a0,a0,-414 # 6a50 <lock_release+0x8dc>
    ...
    1c16:	e3e50513          	addi	a0,a0,-450 # 6a50 <lock_release+0x8dc>
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	f8450513          	addi	a0,a0,-124 # 6c10 <lock_release+0xa9c>
    ...
    1ca2:	f22080e7          	jalr	-222(ra) # 5bc0 <exit>
{
    ...
    1ce8:	f3c50513          	addi	a0,a0,-196 # 6c20 <lock_release+0xaac>
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	12650513          	addi	a0,a0,294 # 6e58 <lock_release+0xce4>
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	08850513          	addi	a0,a0,136 # 6e58 <lock_release+0xce4>
    ...
    1e00:	cec50513          	addi	a0,a0,-788 # 6ae8 <lock_release+0x974>
    ...
    1e72:	dd250513          	addi	a0,a0,-558 # 6c40 <lock_release+0xacc>
    ...
    1ea6:	db650513          	addi	a0,a0,-586 # 6c58 <lock_release+0xae4>
    ...
    1f0c:	d7850513          	addi	a0,a0,-648 # 6c80 <lock_release+0xb0c>
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	29050513          	addi	a0,a0,656 # 6238 <lock_release+0xc4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	254a8a93          	addi	s5,s5,596 # 6238 <lock_release+0xc4>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	cbcb8b93          	addi	s7,s7,-836 # 6ca8 <lock_release+0xb34>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	a5850513          	addi	a0,a0,-1448 # 6a50 <lock_release+0x8dc>
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	c0e50513          	addi	a0,a0,-1010 # 6cc8 <lock_release+0xb54>
  ...
  if(wait(0) != -1){
    ...
    2120:	b9450513          	addi	a0,a0,-1132 # 6cb0 <lock_release+0xb3c>
    ...
    213c:	bb850513          	addi	a0,a0,-1096 # 6cf0 <lock_release+0xb7c>
    ...
    2158:	bb450513          	addi	a0,a0,-1100 # 6d08 <lock_release+0xb94>
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	87c50513          	addi	a0,a0,-1924 # 6a50 <lock_release+0x8dc>
    ...
    21fa:	b2a50513          	addi	a0,a0,-1238 # 6d20 <lock_release+0xbac>
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	7d850513          	addi	a0,a0,2008 # 6a50 <lock_release+0x8dc>
    ...
    22a8:	a9c50513          	addi	a0,a0,-1380 # 6d40 <lock_release+0xbcc>
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	a8450513          	addi	a0,a0,-1404 # 6d58 <lock_release+0xbe4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	a5250513          	addi	a0,a0,-1454 # 6d58 <lock_release+0xbe4>
  ...
  close(fd);
    ...
    2340:	a2c70713          	addi	a4,a4,-1492 # 6d68 <lock_release+0xbf4>
    ...
    2394:	ab850513          	addi	a0,a0,-1352 # 6e48 <lock_release+0xcd4>
    ...
    23b8:	ab450513          	addi	a0,a0,-1356 # 6e68 <lock_release+0xcf4>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	a7650513          	addi	a0,a0,-1418 # 6e88 <lock_release+0xd14>
    ...
    2432:	62250513          	addi	a0,a0,1570 # 6a50 <lock_release+0x8dc>
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	5b450513          	addi	a0,a0,1460 # 6a50 <lock_release+0x8dc>
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	94050513          	addi	a0,a0,-1728 # 6e58 <lock_release+0xce4>
    ...
    25cc:	8e850513          	addi	a0,a0,-1816 # 6eb0 <lock_release+0xd3c>
    ...
    25ec:	cb050513          	addi	a0,a0,-848 # 6298 <lock_release+0x124>
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	52878793          	addi	a5,a5,1320 # 7ba8 <lock_release+0x1a34>
  ...
  if(ret != -1){
    ...
    26c6:	80650513          	addi	a0,a0,-2042 # 6ec8 <lock_release+0xd54>
    ...
    26e4:	29050513          	addi	a0,a0,656 # 6970 <lock_release+0x7fc>
    ...
    2702:	29250513          	addi	a0,a0,658 # 6990 <lock_release+0x81c>
    ...
    2722:	29250513          	addi	a0,a0,658 # 69b0 <lock_release+0x83c>
    ...
    2740:	29c50513          	addi	a0,a0,668 # 69d8 <lock_release+0x864>
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	78050513          	addi	a0,a0,1920 # 6f08 <lock_release+0xd94>
  ...
  if(n >= 0){
    ...
    27bc:	77050513          	addi	a0,a0,1904 # 6f28 <lock_release+0xdb4>
    ...
    27d6:	6fe50513          	addi	a0,a0,1790 # 6ed0 <lock_release+0xd5c>
    ...
    27f0:	6fc50513          	addi	a0,a0,1788 # 6ee8 <lock_release+0xd74>
    ...
    280a:	70a50513          	addi	a0,a0,1802 # 6f10 <lock_release+0xd9c>
  ...
  unlink("rwsbrk");
    ...
    282e:	6de50513          	addi	a0,a0,1758 # 6f08 <lock_release+0xd94>
    2832:	00003097          	auipc	ra,0x3
    2836:	3de080e7          	jalr	990(ra) # 5c10 <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	b6450513          	addi	a0,a0,-1180 # 63a0 <lock_release+0x22c>
  ...
  if(n >= 0){
    ...
    286a:	6f250513          	addi	a0,a0,1778 # 6f58 <lock_release+0xde4>
    ...
    2884:	69050513          	addi	a0,a0,1680 # 6f10 <lock_release+0xd9c>
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	68050513          	addi	a0,a0,1664 # 6f80 <lock_release+0xe0c>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	64e50513          	addi	a0,a0,1614 # 6fa0 <lock_release+0xe2c>
  ...
  if(c != a + 1){
    ...
    29ba:	64a50513          	addi	a0,a0,1610 # 7000 <lock_release+0xe8c>
    ...
    29dc:	5e850513          	addi	a0,a0,1512 # 6fc0 <lock_release+0xe4c>
    ...
    29f8:	5ec50513          	addi	a0,a0,1516 # 6fe0 <lock_release+0xe6c>
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	4e250513          	addi	a0,a0,1250 # 7020 <lock_release+0xeac>
    ...
    2b5e:	50e50513          	addi	a0,a0,1294 # 7068 <lock_release+0xef4>
    ...
    2b7e:	50e50513          	addi	a0,a0,1294 # 7088 <lock_release+0xf14>
    ...
    2b9e:	52e50513          	addi	a0,a0,1326 # 70c8 <lock_release+0xf54>
    ...
    2bba:	54250513          	addi	a0,a0,1346 # 70f8 <lock_release+0xf84>
    ...
    2bda:	55a50513          	addi	a0,a0,1370 # 7130 <lock_release+0xfbc>
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	54850513          	addi	a0,a0,1352 # 7158 <lock_release+0xfe4>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	53650513          	addi	a0,a0,1334 # 7158 <lock_release+0xfe4>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	4ea50513          	addi	a0,a0,1258 # 7160 <lock_release+0xfec>
    ...
    2c96:	4e650513          	addi	a0,a0,1254 # 7178 <lock_release+0x1004>
    ...
    2cb2:	eaa50513          	addi	a0,a0,-342 # 6b58 <lock_release+0x9e4>
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	4b850513          	addi	a0,a0,1208 # 7190 <lock_release+0x101c>
  ...
  close(fd);
    ...
    2d24:	d4850513          	addi	a0,a0,-696 # 6a68 <lock_release+0x8f4>
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	0ea50513          	addi	a0,a0,234 # 6e58 <lock_release+0xce4>
  ...
  if(pid == 0){
    ...
    2dc8:	09450513          	addi	a0,a0,148 # 6e58 <lock_release+0xce4>
  ...
  if(pid == 0){
    ...
    2e28:	03450513          	addi	a0,a0,52 # 6e58 <lock_release+0xce4>
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	ec050513          	addi	a0,a0,-320 # 6e58 <lock_release+0xce4>
    ...
    2ff0:	1dc50513          	addi	a0,a0,476 # 61c8 <lock_release+0x54>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	24078793          	addi	a5,a5,576 # 6238 <lock_release+0xc4>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	33e50513          	addi	a0,a0,830 # 7368 <lock_release+0x11f4>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	18450513          	addi	a0,a0,388 # 71c0 <lock_release+0x104c>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	1c650513          	addi	a0,a0,454 # 7218 <lock_release+0x10a4>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	22050513          	addi	a0,a0,544 # 7290 <lock_release+0x111c>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	27450513          	addi	a0,a0,628 # 7300 <lock_release+0x118c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	2ba50513          	addi	a0,a0,698 # 7358 <lock_release+0x11e4>
  ...
  unlink("12345678901234");
    ...
    3120:	07c50513          	addi	a0,a0,124 # 7198 <lock_release+0x1024>
    ...
    313c:	0a850513          	addi	a0,a0,168 # 71e0 <lock_release+0x106c>
    ...
    3158:	0f450513          	addi	a0,a0,244 # 7248 <lock_release+0x10d4>
    ...
    3174:	15050513          	addi	a0,a0,336 # 72c0 <lock_release+0x114c>
    ...
    3190:	19450513          	addi	a0,a0,404 # 7320 <lock_release+0x11ac>
    ...
    31ac:	1d050513          	addi	a0,a0,464 # 7378 <lock_release+0x1204>
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	1bc50513          	addi	a0,a0,444 # 73b0 <lock_release+0x123c>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	1a250513          	addi	a0,a0,418 # 73c0 <lock_release+0x124c>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	10250513          	addi	a0,a0,258 # 73b0 <lock_release+0x123c>
  ...
  unlink("diskfulldir");
    ...
    32c6:	0ee50513          	addi	a0,a0,238 # 73b0 <lock_release+0x123c>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	ff050513          	addi	a0,a0,-16 # 73e0 <lock_release+0x126c>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	00250513          	addi	a0,a0,2 # 7410 <lock_release+0x129c>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	fee50513          	addi	a0,a0,-18 # 7410 <lock_release+0x129c>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	01a50513          	addi	a0,a0,26 # 7450 <lock_release+0x12dc>
  ...
  if(chdir("/") < 0){
    ...
    344e:	03650513          	addi	a0,a0,54 # 7480 <lock_release+0x130c>
    ...
    346e:	fae50513          	addi	a0,a0,-82 # 7418 <lock_release+0x12a4>
    ...
    348a:	faa50513          	addi	a0,a0,-86 # 7430 <lock_release+0x12bc>
    ...
    34a6:	fbe50513          	addi	a0,a0,-66 # 7460 <lock_release+0x12ec>
    ...
    34c2:	fca50513          	addi	a0,a0,-54 # 7488 <lock_release+0x1314>
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	f1e50513          	addi	a0,a0,-226 # 7410 <lock_release+0x129c>
    ...
    350a:	f0a50513          	addi	a0,a0,-246 # 7410 <lock_release+0x129c>
    ...
    351e:	f3650513          	addi	a0,a0,-202 # 7450 <lock_release+0x12dc>
    ...
    353e:	51650513          	addi	a0,a0,1302 # 6a50 <lock_release+0x8dc>
    ...
    355a:	ec250513          	addi	a0,a0,-318 # 7418 <lock_release+0x12a4>
    ...
    3576:	f2e50513          	addi	a0,a0,-210 # 74a0 <lock_release+0x132c>
    ...
    3592:	ed250513          	addi	a0,a0,-302 # 7460 <lock_release+0x12ec>
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	eec50513          	addi	a0,a0,-276 # 74b8 <lock_release+0x1344>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	ed850513          	addi	a0,a0,-296 # 74b8 <lock_release+0x1344>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	ee450513          	addi	a0,a0,-284 # 74d8 <lock_release+0x1364>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	eb050513          	addi	a0,a0,-336 # 74b8 <lock_release+0x1344>
    ...
    362c:	df050513          	addi	a0,a0,-528 # 7418 <lock_release+0x12a4>
    ...
    3648:	e7c50513          	addi	a0,a0,-388 # 74c0 <lock_release+0x134c>
    ...
    3664:	e8050513          	addi	a0,a0,-384 # 74e0 <lock_release+0x136c>
    ...
    3680:	e7c50513          	addi	a0,a0,-388 # 74f8 <lock_release+0x1384>
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	f9c50513          	addi	a0,a0,-100 # 7640 <lock_release+0x14cc>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	564080e7          	jalr	1380(ra) # 5c10 <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	e5c50513          	addi	a0,a0,-420 # 7510 <lock_release+0x139c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	e6450513          	addi	a0,a0,-412 # 7530 <lock_release+0x13bc>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	f5c58593          	addi	a1,a1,-164 # 7640 <lock_release+0x14cc>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	e1250513          	addi	a0,a0,-494 # 7510 <lock_release+0x139c>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	e7650513          	addi	a0,a0,-394 # 7588 <lock_release+0x1414>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	e8650513          	addi	a0,a0,-378 # 75b0 <lock_release+0x143c>
  ...
  write(fd, "FF", 2);
    ...
    3746:	e9e58593          	addi	a1,a1,-354 # 75e0 <lock_release+0x146c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	e8a50513          	addi	a0,a0,-374 # 75e8 <lock_release+0x1474>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	e9258593          	addi	a1,a1,-366 # 7638 <lock_release+0x14c4>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	e0250513          	addi	a0,a0,-510 # 75b0 <lock_release+0x143c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	dee50513          	addi	a0,a0,-530 # 75b0 <lock_release+0x143c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	dd850513          	addi	a0,a0,-552 # 75b0 <lock_release+0x143c>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	d2450513          	addi	a0,a0,-732 # 7510 <lock_release+0x139c>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	ed050513          	addi	a0,a0,-304 # 76d0 <lock_release+0x155c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	eec50513          	addi	a0,a0,-276 # 7700 <lock_release+0x158c>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	f0850513          	addi	a0,a0,-248 # 7730 <lock_release+0x15bc>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	dfa50513          	addi	a0,a0,-518 # 7638 <lock_release+0x14c4>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	d3850513          	addi	a0,a0,-712 # 75b0 <lock_release+0x143c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	f3050513          	addi	a0,a0,-208 # 77c0 <lock_release+0x164c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	f4850513          	addi	a0,a0,-184 # 77f0 <lock_release+0x167c>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	c5050513          	addi	a0,a0,-944 # 7510 <lock_release+0x139c>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	c3a50513          	addi	a0,a0,-966 # 7510 <lock_release+0x139c>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	c2450513          	addi	a0,a0,-988 # 7510 <lock_release+0x139c>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	f8058593          	addi	a1,a1,-128 # 7880 <lock_release+0x170c>
    3908:	00004517          	auipc	a0,0x4
    390c:	eb850513          	addi	a0,a0,-328 # 77c0 <lock_release+0x164c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	f6458593          	addi	a1,a1,-156 # 7880 <lock_release+0x170c>
    3924:	00004517          	auipc	a0,0x4
    3928:	ecc50513          	addi	a0,a0,-308 # 77f0 <lock_release+0x167c>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	d0058593          	addi	a1,a1,-768 # 7638 <lock_release+0x14c4>
    3940:	00004517          	auipc	a0,0x4
    3944:	bf050513          	addi	a0,a0,-1040 # 7530 <lock_release+0x13bc>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	e6c50513          	addi	a0,a0,-404 # 77c0 <lock_release+0x164c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	e8850513          	addi	a0,a0,-376 # 77f0 <lock_release+0x167c>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	cbc50513          	addi	a0,a0,-836 # 7638 <lock_release+0x14c4>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	e6050513          	addi	a0,a0,-416 # 77f0 <lock_release+0x167c>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	e1c50513          	addi	a0,a0,-484 # 77c0 <lock_release+0x164c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	b7850513          	addi	a0,a0,-1160 # 7530 <lock_release+0x13bc>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	00450513          	addi	a0,a0,4 # 79d0 <lock_release+0x185c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	c5850513          	addi	a0,a0,-936 # 7638 <lock_release+0x14c4>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	b3c50513          	addi	a0,a0,-1220 # 7530 <lock_release+0x13bc>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	b0850513          	addi	a0,a0,-1272 # 7510 <lock_release+0x139c>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	02450513          	addi	a0,a0,36 # 7a40 <lock_release+0x18cc>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	ae050513          	addi	a0,a0,-1312 # 7510 <lock_release+0x139c>
    ...
    3a56:	ac650513          	addi	a0,a0,-1338 # 7518 <lock_release+0x13a4>
    ...
    3a72:	aca50513          	addi	a0,a0,-1334 # 7538 <lock_release+0x13c4>
    ...
    3a8e:	ace50513          	addi	a0,a0,-1330 # 7558 <lock_release+0x13e4>
    ...
    3aaa:	aea50513          	addi	a0,a0,-1302 # 7590 <lock_release+0x141c>
    ...
    3ac6:	afe50513          	addi	a0,a0,-1282 # 75c0 <lock_release+0x144c>
    ...
    3ae2:	b1a50513          	addi	a0,a0,-1254 # 75f8 <lock_release+0x1484>
    ...
    3afe:	b1e50513          	addi	a0,a0,-1250 # 7618 <lock_release+0x14a4>
    ...
    3b1a:	b3250513          	addi	a0,a0,-1230 # 7648 <lock_release+0x14d4>
    ...
    3b36:	b3e50513          	addi	a0,a0,-1218 # 7670 <lock_release+0x14fc>
    ...
    3b52:	b4250513          	addi	a0,a0,-1214 # 7690 <lock_release+0x151c>
    ...
    3b6e:	b4e50513          	addi	a0,a0,-1202 # 76b8 <lock_release+0x1544>
    ...
    3b8a:	b5a50513          	addi	a0,a0,-1190 # 76e0 <lock_release+0x156c>
    ...
    3ba6:	b6e50513          	addi	a0,a0,-1170 # 7710 <lock_release+0x159c>
    ...
    3bc2:	b7a50513          	addi	a0,a0,-1158 # 7738 <lock_release+0x15c4>
    ...
    3bde:	b7650513          	addi	a0,a0,-1162 # 7750 <lock_release+0x15dc>
    ...
    3bfa:	b7a50513          	addi	a0,a0,-1158 # 7770 <lock_release+0x15fc>
    ...
    3c16:	b7e50513          	addi	a0,a0,-1154 # 7790 <lock_release+0x161c>
    ...
    3c32:	ba250513          	addi	a0,a0,-1118 # 77d0 <lock_release+0x165c>
    ...
    3c4e:	bb650513          	addi	a0,a0,-1098 # 7800 <lock_release+0x168c>
    ...
    3c6a:	bba50513          	addi	a0,a0,-1094 # 7820 <lock_release+0x16ac>
    ...
    3c86:	bbe50513          	addi	a0,a0,-1090 # 7840 <lock_release+0x16cc>
    ...
    3ca2:	bc250513          	addi	a0,a0,-1086 # 7860 <lock_release+0x16ec>
    ...
    3cbe:	bd650513          	addi	a0,a0,-1066 # 7890 <lock_release+0x171c>
    ...
    3cda:	be250513          	addi	a0,a0,-1054 # 78b8 <lock_release+0x1744>
    ...
    3cf6:	bee50513          	addi	a0,a0,-1042 # 78e0 <lock_release+0x176c>
    ...
    3d12:	bfa50513          	addi	a0,a0,-1030 # 7908 <lock_release+0x1794>
    ...
    3d2e:	bfe50513          	addi	a0,a0,-1026 # 7928 <lock_release+0x17b4>
    ...
    3d4a:	c0250513          	addi	a0,a0,-1022 # 7948 <lock_release+0x17d4>
    ...
    3d66:	c0e50513          	addi	a0,a0,-1010 # 7970 <lock_release+0x17fc>
    ...
    3d82:	c1250513          	addi	a0,a0,-1006 # 7990 <lock_release+0x181c>
    ...
    3d9e:	c1650513          	addi	a0,a0,-1002 # 79b0 <lock_release+0x183c>
    ...
    3dba:	c2250513          	addi	a0,a0,-990 # 79d8 <lock_release+0x1864>
    ...
    3dd6:	89e50513          	addi	a0,a0,-1890 # 7670 <lock_release+0x14fc>
    ...
    3df2:	c0a50513          	addi	a0,a0,-1014 # 79f8 <lock_release+0x1884>
    ...
    3e0e:	c0e50513          	addi	a0,a0,-1010 # 7a18 <lock_release+0x18a4>
    ...
    3e2a:	c2250513          	addi	a0,a0,-990 # 7a48 <lock_release+0x18d4>
    ...
    3e46:	c2650513          	addi	a0,a0,-986 # 7a68 <lock_release+0x18f4>
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	c1850513          	addi	a0,a0,-1000 # 7a80 <lock_release+0x190c>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	c0650513          	addi	a0,a0,-1018 # 7a80 <lock_release+0x190c>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	a2450513          	addi	a0,a0,-1500 # 68b0 <lock_release+0x73c>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	63a50513          	addi	a0,a0,1594 # 74d8 <lock_release+0x1364>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	5d050513          	addi	a0,a0,1488 # 7480 <lock_release+0x130c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	c2650513          	addi	a0,a0,-986 # 7ae8 <lock_release+0x1974>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	c3c50513          	addi	a0,a0,-964 # 7b10 <lock_release+0x199c>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	b9a50513          	addi	a0,a0,-1126 # 7a80 <lock_release+0x190c>
    ...
    3f08:	b8450513          	addi	a0,a0,-1148 # 7a88 <lock_release+0x1914>
    ...
    3f24:	b8050513          	addi	a0,a0,-1152 # 7aa0 <lock_release+0x192c>
    ...
    3f40:	b7c50513          	addi	a0,a0,-1156 # 7ab8 <lock_release+0x1944>
    ...
    3f5c:	b7850513          	addi	a0,a0,-1160 # 7ad0 <lock_release+0x195c>
    ...
    3f78:	51450513          	addi	a0,a0,1300 # 7488 <lock_release+0x1314>
    ...
    3f94:	b6050513          	addi	a0,a0,-1184 # 7af0 <lock_release+0x197c>
    ...
    3fb0:	b6c50513          	addi	a0,a0,-1172 # 7b18 <lock_release+0x19a4>
    ...
    3fcc:	b7050513          	addi	a0,a0,-1168 # 7b38 <lock_release+0x19c4>
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	b6450513          	addi	a0,a0,-1180 # 7b58 <lock_release+0x19e4>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	b4850513          	addi	a0,a0,-1208 # 7b58 <lock_release+0x19e4>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	b7c50513          	addi	a0,a0,-1156 # 7ba0 <lock_release+0x1a2c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	b6450513          	addi	a0,a0,-1180 # 7ba0 <lock_release+0x1a2c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	b5050513          	addi	a0,a0,-1200 # 7ba0 <lock_release+0x1a2c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	b3c50513          	addi	a0,a0,-1220 # 7ba0 <lock_release+0x1a2c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	b2858593          	addi	a1,a1,-1240 # 7ba0 <lock_release+0x1a2c>
    4080:	00002517          	auipc	a0,0x2
    4084:	32050513          	addi	a0,a0,800 # 63a0 <lock_release+0x22c>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	ac450513          	addi	a0,a0,-1340 # 7b58 <lock_release+0x19e4>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	80650513          	addi	a0,a0,-2042 # 68b0 <lock_release+0x73c>
  ...
  fd = open(".", 0);
    ...
    40c4:	7f050513          	addi	a0,a0,2032 # 68b0 <lock_release+0x73c>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	16458593          	addi	a1,a1,356 # 6238 <lock_release+0xc4>
  ...
  close(fd);
    ...
    4104:	a6050513          	addi	a0,a0,-1440 # 7b60 <lock_release+0x19ec>
    ...
    4120:	a6450513          	addi	a0,a0,-1436 # 7b80 <lock_release+0x1a0c>
    ...
    413c:	a7850513          	addi	a0,a0,-1416 # 7bb0 <lock_release+0x1a3c>
    ...
    4158:	a5c50513          	addi	a0,a0,-1444 # 7bb0 <lock_release+0x1a3c>
    ...
    4174:	a6850513          	addi	a0,a0,-1432 # 7bd8 <lock_release+0x1a64>
    ...
    4190:	a7450513          	addi	a0,a0,-1420 # 7c00 <lock_release+0x1a8c>
    ...
    41ac:	a8050513          	addi	a0,a0,-1408 # 7c28 <lock_release+0x1ab4>
    ...
    41c8:	a8c50513          	addi	a0,a0,-1396 # 7c50 <lock_release+0x1adc>
    ...
    41e4:	a9050513          	addi	a0,a0,-1392 # 7c70 <lock_release+0x1afc>
    ...
    4200:	a9c50513          	addi	a0,a0,-1380 # 7c98 <lock_release+0x1b24>
...
0000000000004216 <iref>:
{
    ...
    4234:	a80a0a13          	addi	s4,s4,-1408 # 7cb0 <lock_release+0x1b3c>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	58048493          	addi	s1,s1,1408 # 77b8 <lock_release+0x1644>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	160a8a93          	addi	s5,s5,352 # 63a0 <lock_release+0x22c>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	96098993          	addi	s3,s3,-1696 # 7ba8 <lock_release+0x1a34>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	a6450513          	addi	a0,a0,-1436 # 7cb8 <lock_release+0x1b44>
    ...
    4274:	a6050513          	addi	a0,a0,-1440 # 7cd0 <lock_release+0x1b5c>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	1d498993          	addi	s3,s3,468 # 74d8 <lock_release+0x1364>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	9a490913          	addi	s2,s2,-1628 # 7cb0 <lock_release+0x1b3c>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	15450513          	addi	a0,a0,340 # 7480 <lock_release+0x130c>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	98c50513          	addi	a0,a0,-1652 # 7ce8 <lock_release+0x1b74>
  ...
  if(pid == 0){
    ...
    4384:	96850513          	addi	a0,a0,-1688 # 7ce8 <lock_release+0x1b74>
    ...
    439a:	97250513          	addi	a0,a0,-1678 # 7d08 <lock_release+0x1b94>
    ...
    43b6:	93e50513          	addi	a0,a0,-1730 # 7cf0 <lock_release+0x1b7c>
    ...
    43d2:	68250513          	addi	a0,a0,1666 # 6a50 <lock_release+0x8dc>
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	8ec50513          	addi	a0,a0,-1812 # 7ce8 <lock_release+0x1b74>
    ...
    4414:	83050513          	addi	a0,a0,-2000 # 6c40 <lock_release+0xacc>
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	8e250513          	addi	a0,a0,-1822 # 7d30 <lock_release+0x1bbc>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	8b650513          	addi	a0,a0,-1866 # 7d30 <lock_release+0x1bbc>
  ...
  sleep(10); // one second
    ...
    44b6:	75e50513          	addi	a0,a0,1886 # 6c10 <lock_release+0xa9c>
    ...
    44d0:	86448493          	addi	s1,s1,-1948 # 7d30 <lock_release+0x1bbc>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
0000000000004512 <killstatus>:
{
  ...
  exit(0);
    ...
    4578:	4dc50513          	addi	a0,a0,1244 # 6a50 <lock_release+0x8dc>
    ...
    459e:	7a650513          	addi	a0,a0,1958 # 7d40 <lock_release+0x1bcc>
...
00000000000045b4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45de:	63650513          	addi	a0,a0,1590 # 6c10 <lock_release+0xa9c>
  ...
  if(pid2 == 0)
    ...
    460c:	44850513          	addi	a0,a0,1096 # 6a50 <lock_release+0x8dc>
  ...
  if(pid3 == 0){
    ...
    4650:	bec58593          	addi	a1,a1,-1044 # 6238 <lock_release+0xc4>
    ...
    467a:	3da50513          	addi	a0,a0,986 # 6a50 <lock_release+0x8dc>
    ...
    4696:	6ce50513          	addi	a0,a0,1742 # 7d60 <lock_release+0x1bec>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d2:	6aa50513          	addi	a0,a0,1706 # 7d78 <lock_release+0x1c04>
  ...
  printf("kill... ");
    ...
    46fe:	69650513          	addi	a0,a0,1686 # 7d90 <lock_release+0x1c1c>
  ...
  printf("wait... ");
    ...
    472c:	67850513          	addi	a0,a0,1656 # 7da0 <lock_release+0x1c2c>
...
0000000000004758 <reparent>:
{
  ...
  exit(0);
    ...
    47ac:	2a850513          	addi	a0,a0,680 # 6a50 <lock_release+0x8dc>
    ...
    47c8:	41450513          	addi	a0,a0,1044 # 6bd8 <lock_release+0xa64>
...
0000000000004808 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    483e:	31e50513          	addi	a0,a0,798 # 6b58 <lock_release+0x9e4>
    ...
    4872:	9ca58593          	addi	a1,a1,-1590 # 6238 <lock_release+0xc4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4936:	47e50513          	addi	a0,a0,1150 # 7db0 <lock_release+0x1c3c>
    ...
    4952:	10250513          	addi	a0,a0,258 # 6a50 <lock_release+0x8dc>
    ...
    499e:	43650513          	addi	a0,a0,1078 # 7dd0 <lock_release+0x1c5c>
...
00000000000049be <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a42:	3c250513          	addi	a0,a0,962 # 7e00 <lock_release+0x1c8c>
...
0000000000004a62 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4af8:	33c50513          	addi	a0,a0,828 # 7e30 <lock_release+0x1cbc>
    ...
    4b14:	34850513          	addi	a0,a0,840 # 7e58 <lock_release+0x1ce4>
  ...
  fd = open("sharedfd", 0);
    ...
    4b58:	2cc50513          	addi	a0,a0,716 # 7e20 <lock_release+0x1cac>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b98:	2e450513          	addi	a0,a0,740 # 7e78 <lock_release+0x1d04>
  ...
  unlink("sharedfd");
    ...
    4bd4:	25050513          	addi	a0,a0,592 # 7e20 <lock_release+0x1cac>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4bfa:	2aa50513          	addi	a0,a0,682 # 7ea0 <lock_release+0x1d2c>
...
0000000000004c1a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c40:	27c78793          	addi	a5,a5,636 # 7eb8 <lock_release+0x1d44>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	27878793          	addi	a5,a5,632 # 7ec0 <lock_release+0x1d4c>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	27478793          	addi	a5,a5,628 # 7ec8 <lock_release+0x1d54>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	27078793          	addi	a5,a5,624 # 7ed0 <lock_release+0x1d5c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cdc:	18050513          	addi	a0,a0,384 # 6e58 <lock_release+0xce4>
    ...
    4d58:	18450513          	addi	a0,a0,388 # 7ed8 <lock_release+0x1d64>
    ...
    4d72:	17a50513          	addi	a0,a0,378 # 7ee8 <lock_release+0x1d74>
    ...
    4d9a:	16a50513          	addi	a0,a0,362 # 7f00 <lock_release+0x1d8c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e28:	0ec50513          	addi	a0,a0,236 # 7f10 <lock_release+0x1d9c>
...
0000000000004e5c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e8a:	0a2b8b93          	addi	s7,s7,162 # 7f28 <lock_release+0x1db4>
  for(i = 0; i < N; i++){
    ...
    4ecc:	06850513          	addi	a0,a0,104 # 7f30 <lock_release+0x1dbc>
    ...
    4eea:	04250513          	addi	a0,a0,66 # 7f28 <lock_release+0x1db4>
  ...
  fd = open(".", 0);
    ...
    4f22:	99250513          	addi	a0,a0,-1646 # 68b0 <lock_release+0x73c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9a:	fba50513          	addi	a0,a0,-70 # 7f50 <lock_release+0x1ddc>
    ...
    4fba:	fba50513          	addi	a0,a0,-70 # 7f70 <lock_release+0x1dfc>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff2:	faa50513          	addi	a0,a0,-86 # 7f98 <lock_release+0x1e24>
    ...
    500e:	a4650513          	addi	a0,a0,-1466 # 6a50 <lock_release+0x8dc>
...
00000000000051b8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5240:	d9450513          	addi	a0,a0,-620 # 7fd0 <lock_release+0x1e5c>
  ...
  for(i = 0; ; i++){
    ...
    52a4:	d4050513          	addi	a0,a0,-704 # 7fe0 <lock_release+0x1e6c>
    ...
    52c0:	d4450513          	addi	a0,a0,-700 # 8000 <lock_release+0x1e8c>
    ...
    52dc:	d4850513          	addi	a0,a0,-696 # 8020 <lock_release+0x1eac>
    ...
    52f8:	d4c50513          	addi	a0,a0,-692 # 8040 <lock_release+0x1ecc>
    ...
    5314:	d5050513          	addi	a0,a0,-688 # 8060 <lock_release+0x1eec>
    ...
    5330:	d4c50513          	addi	a0,a0,-692 # 8078 <lock_release+0x1f04>
  ...
  unlink("bigfile.dat");
    ...
    535e:	c7650513          	addi	a0,a0,-906 # 7fd0 <lock_release+0x1e5c>
    ...
    5382:	d1a50513          	addi	a0,a0,-742 # 8098 <lock_release+0x1f24>
...
0000000000005398 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53ba:	d0250513          	addi	a0,a0,-766 # 80b8 <lock_release+0x1f44>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53da:	cf2c8c93          	addi	s9,s9,-782 # 80c8 <lock_release+0x1f54>
    int total = 0;
    53de:	4d81                	li	s11,0
    ...
    5454:	c8850513          	addi	a0,a0,-888 # 80d8 <lock_release+0x1f64>
  ...
  printf("fsfull test finished\n");
    ...
    54ca:	c3250513          	addi	a0,a0,-974 # 80f8 <lock_release+0x1f84>
    ...
    551a:	bd250513          	addi	a0,a0,-1070 # 80e8 <lock_release+0x1f74>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    554c:	bc850513          	addi	a0,a0,-1080 # 8110 <lock_release+0x1f9c>
  ...
  if(pid == 0) {
    ...
    557c:	bc050513          	addi	a0,a0,-1088 # 8138 <lock_release+0x1fc4>
    ...
    55a0:	b8450513          	addi	a0,a0,-1148 # 8120 <lock_release+0x1fac>
    ...
    55c8:	b7c50513          	addi	a0,a0,-1156 # 8140 <lock_release+0x1fcc>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5618:	b3450513          	addi	a0,a0,-1228 # 8148 <lock_release+0x1fd4>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5672:	bca98993          	addi	s3,s3,-1078 # 6238 <lock_release+0xc4>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a4:	b0050513          	addi	a0,a0,-1280 # 81a0 <lock_release+0x202c>
    ...
    56be:	aa650513          	addi	a0,a0,-1370 # 8160 <lock_release+0x1fec>
    ...
    56d8:	aac50513          	addi	a0,a0,-1364 # 8180 <lock_release+0x200c>
  ...
  while(1){
    ...
    5726:	a9e50513          	addi	a0,a0,-1378 # 81c0 <lock_release+0x204c>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5788:	a5cb8b93          	addi	s7,s7,-1444 # 81e0 <lock_release+0x206c>
    int free0 = countfree();
    int free1 = 0;
    ...
    579a:	a82c8c93          	addi	s9,s9,-1406 # 8218 <lock_release+0x20a4>
      if (runtests(slowtests, justone)) {
    579e:	00004c17          	auipc	s8,0x4
    57a2:	c42c0c13          	addi	s8,s8,-958 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    57a6:	00003d17          	auipc	s10,0x3
    57aa:	a52d0d13          	addi	s10,s10,-1454 # 81f8 <lock_release+0x2084>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    589e:	9ae58593          	addi	a1,a1,-1618 # 8248 <lock_release+0x20d4>
    ...
    58b6:	9ee58593          	addi	a1,a1,-1554 # 82a0 <lock_release+0x212c>
    ...
    58cc:	9d058593          	addi	a1,a1,-1584 # 8298 <lock_release+0x2124>
  ...
  int continuous = 0;
    ...
    58f8:	95c50513          	addi	a0,a0,-1700 # 8250 <lock_release+0x20dc>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5924:	96050513          	addi	a0,a0,-1696 # 8280 <lock_release+0x210c>
...
0000000000005c78 <sched_tickets>:
...
0000000000005c80 <sched_statistics>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cd8:	99450513          	addi	a0,a0,-1644 # 8668 <digits>
    5cdc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d92:	4c55                	li	s8,21
    5d94:	00003c97          	auipc	s9,0x3
    5d98:	87cc8c93          	addi	s9,s9,-1924 # 8610 <lock_release+0x249c>
  ...
  putc(fd, 'x');
    ...
    5da6:	8c6b8b93          	addi	s7,s7,-1850 # 8668 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ecc:	74098993          	addi	s3,s3,1856 # 8608 <lock_release+0x2494>
        while(*s != 0){
    5ed0:	85ee                	mv	a1,s11
...
0000000000006108 <thread_create>:
#include "user/user.h"
...
{
    6108:	1101                	addi	sp,sp,-32
    610a:	ec06                	sd	ra,24(sp)
    610c:	e822                	sd	s0,16(sp)
    610e:	e426                	sd	s1,8(sp)
    6110:	e04a                	sd	s2,0(sp)
    6112:	1000                	addi	s0,sp,32
    6114:	84aa                	mv	s1,a0
    6116:	892e                	mv	s2,a1
    int pg_size = 4096*sizeof(void);
    void* stack = (void*)malloc(pg_size);
    6118:	6505                	lui	a0,0x1
    611a:	00000097          	auipc	ra,0x0
    611e:	f08080e7          	jalr	-248(ra) # 6022 <malloc>
    int t_id = clone(stack);
    6122:	00000097          	auipc	ra,0x0
    6126:	b66080e7          	jalr	-1178(ra) # 5c88 <clone>
    if(t_id==0) {
    612a:	c901                	beqz	a0,613a <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
    ...
    612c:	4501                	li	a0,0
    612e:	60e2                	ld	ra,24(sp)
    6130:	6442                	ld	s0,16(sp)
    6132:	64a2                	ld	s1,8(sp)
    6134:	6902                	ld	s2,0(sp)
    6136:	6105                	addi	sp,sp,32
    6138:	8082                	ret
        (*start_routine)(arg);
    613a:	854a                	mv	a0,s2
    613c:	9482                	jalr	s1
    ...
    6144:	a80080e7          	jalr	-1408(ra) # 5bc0 <exit>

0000000000006148 <lock_init>:

void
lock_init(struct lock_t *lock)
{
    6148:	1141                	addi	sp,sp,-16
    614a:	e422                	sd	s0,8(sp)
    614c:	0800                	addi	s0,sp,16
    lock->locked = 0;
    614e:	00052023          	sw	zero,0(a0) # 1000 <linktest+0x10c>
}
    6152:	6422                	ld	s0,8(sp)
    6154:	0141                	addi	sp,sp,16
    6156:	8082                	ret

0000000000006158 <lock_acquire>:

void
lock_acquire(struct lock_t *lock)
{
    6158:	1141                	addi	sp,sp,-16
    615a:	e422                	sd	s0,8(sp)
    615c:	0800                	addi	s0,sp,16
    while(__sync_lock_test_and_set(&lock->locked, 1)!= 0);
    615e:	4705                	li	a4,1
    6160:	87ba                	mv	a5,a4
    6162:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    6166:	2781                	sext.w	a5,a5
    6168:	ffe5                	bnez	a5,6160 <lock_acquire+0x8>
    __sync_synchronize();
    616a:	0ff0000f          	fence
}
    616e:	6422                	ld	s0,8(sp)
    6170:	0141                	addi	sp,sp,16
    6172:	8082                	ret

0000000000006174 <lock_release>:

void
lock_release(struct lock_t *lock)
{
    6174:	1141                	addi	sp,sp,-16
    6176:	e422                	sd	s0,8(sp)
    6178:	0800                	addi	s0,sp,16
    __sync_synchronize();
    617a:	0ff0000f          	fence
    __sync_lock_release(&lock->locked, 0);
    617e:	0f50000f          	fence	iorw,ow
    6182:	0805202f          	amoswap.w	zero,zero,(a0)
}
    6186:	6422                	ld	s0,8(sp)
    6188:	0141                	addi	sp,sp,16
    618a:	8082                	ret
