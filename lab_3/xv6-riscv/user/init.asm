...
main(void)
{
  ...
  12:	94250513          	addi	a0,a0,-1726 # 950 <lock_release+0x1e>
  ...
  3a:	92290913          	addi	s2,s2,-1758 # 958 <lock_release+0x26>
  3e:	854a                	mv	a0,s2
  ...
  6e:	93e50513          	addi	a0,a0,-1730 # 9a8 <lock_release+0x76>
  ...
  8c:	8c850513          	addi	a0,a0,-1848 # 950 <lock_release+0x1e>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	8b650513          	addi	a0,a0,-1866 # 950 <lock_release+0x1e>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	8c450513          	addi	a0,a0,-1852 # 970 <lock_release+0x3e>
  ...
  d2:	8ba50513          	addi	a0,a0,-1862 # 988 <lock_release+0x56>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	8b250513          	addi	a0,a0,-1870 # 990 <lock_release+0x5e>
...
0000000000000436 <sched_tickets>:
...
000000000000043e <sched_statistics>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 496:	59650513          	addi	a0,a0,1430 # a28 <digits>
 49a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 556:	47ec8c93          	addi	s9,s9,1150 # 9d0 <lock_release+0x9e>
 ...
 564:	4c8b8b93          	addi	s7,s7,1224 # a28 <digits>
 ...
 68a:	34298993          	addi	s3,s3,834 # 9c8 <lock_release+0x96>
        while(*s != 0){
 68e:	85ee                	mv	a1,s11
...
00000000000008c6 <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 8dc:	f08080e7          	jalr	-248(ra) # 7e0 <malloc>
    int t_id = clone(stack);
 8e0:	00000097          	auipc	ra,0x0
 8e4:	b66080e7          	jalr	-1178(ra) # 446 <clone>
    if(t_id==0) {
 8e8:	c901                	beqz	a0,8f8 <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 902:	a80080e7          	jalr	-1408(ra) # 37e <exit>

0000000000000906 <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 90a:	0800                	addi	s0,sp,16
    lock->locked = 0;
 90c:	00052023          	sw	zero,0(a0) # 1000 <argv>
}
 910:	6422                	ld	s0,8(sp)
 912:	0141                	addi	sp,sp,16
 914:	8082                	ret

0000000000000916 <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 91c:	4705                	li	a4,1
 91e:	87ba                	mv	a5,a4
 920:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 924:	2781                	sext.w	a5,a5
 926:	ffe5                	bnez	a5,91e <lock_acquire+0x8>
    __sync_synchronize();
 928:	0ff0000f          	fence
}
 92c:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 93c:	0f50000f          	fence	iorw,ow
 940:	0805202f          	amoswap.w	zero,zero,(a0)
}
 944:	6422                	ld	s0,8(sp)
