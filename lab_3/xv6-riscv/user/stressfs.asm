...
main(int argc, char *argv[])
{
  ...
  1a:	97a78793          	addi	a5,a5,-1670 # 990 <lock_release+0x4a>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	93450513          	addi	a0,a0,-1740 # 960 <lock_release+0x1a>
  ...
  6c:	91050513          	addi	a0,a0,-1776 # 978 <lock_release+0x32>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8d250513          	addi	a0,a0,-1838 # 988 <lock_release+0x42>
...
000000000000044a <sched_tickets>:
...
0000000000000452 <sched_statistics>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 56a:	442c8c93          	addi	s9,s9,1090 # 9a8 <lock_release+0x62>
 ...
 578:	48cb8b93          	addi	s7,s7,1164 # a00 <digits>
 ...
 69e:	30698993          	addi	s3,s3,774 # 9a0 <lock_release+0x5a>
        while(*s != 0){
 6a2:	85ee                	mv	a1,s11
...
00000000000008da <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 8f0:	f08080e7          	jalr	-248(ra) # 7f4 <malloc>
    int t_id = clone(stack);
 8f4:	00000097          	auipc	ra,0x0
 8f8:	b66080e7          	jalr	-1178(ra) # 45a <clone>
    if(t_id==0) {
 8fc:	c901                	beqz	a0,90c <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 916:	a80080e7          	jalr	-1408(ra) # 392 <exit>

000000000000091a <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 91e:	0800                	addi	s0,sp,16
    lock->locked = 0;
 920:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 924:	6422                	ld	s0,8(sp)
 926:	0141                	addi	sp,sp,16
 928:	8082                	ret

000000000000092a <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 930:	4705                	li	a4,1
 932:	87ba                	mv	a5,a4
 934:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 938:	2781                	sext.w	a5,a5
 93a:	ffe5                	bnez	a5,932 <lock_acquire+0x8>
    __sync_synchronize();
 93c:	0ff0000f          	fence
}
 940:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 950:	0f50000f          	fence	iorw,ow
 954:	0805202f          	amoswap.w	zero,zero,(a0)
}
 958:	6422                	ld	s0,8(sp)
