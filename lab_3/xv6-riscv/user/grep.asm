...
00000000000001de <main>:
{
 ...
 252:	8a258593          	addi	a1,a1,-1886 # af0 <lock_release+0x18>
 256:	4509                	li	a0,2
 ...
 288:	88c50513          	addi	a0,a0,-1908 # b10 <lock_release+0x38>
...
00000000000005dc <sched_tickets>:
...
00000000000005e4 <sched_statistics>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 63c:	55050513          	addi	a0,a0,1360 # b88 <digits>
 640:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6fc:	438c8c93          	addi	s9,s9,1080 # b30 <lock_release+0x58>
 ...
 830:	2fc98993          	addi	s3,s3,764 # b28 <lock_release+0x50>
        while(*s != 0){
 834:	85ee                	mv	a1,s11
...
0000000000000a6c <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 a82:	f08080e7          	jalr	-248(ra) # 986 <malloc>
    int t_id = clone(stack);
 a86:	00000097          	auipc	ra,0x0
 a8a:	b66080e7          	jalr	-1178(ra) # 5ec <clone>
    if(t_id==0) {
 a8e:	c901                	beqz	a0,a9e <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 aa8:	a80080e7          	jalr	-1408(ra) # 524 <exit>

0000000000000aac <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 ab0:	0800                	addi	s0,sp,16
    lock->locked = 0;
 ab2:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 ab6:	6422                	ld	s0,8(sp)
 ab8:	0141                	addi	sp,sp,16
 aba:	8082                	ret

0000000000000abc <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 ac2:	4705                	li	a4,1
 ac4:	87ba                	mv	a5,a4
 ac6:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 aca:	2781                	sext.w	a5,a5
 acc:	ffe5                	bnez	a5,ac4 <lock_acquire+0x8>
    __sync_synchronize();
 ace:	0ff0000f          	fence
}
 ad2:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 ae2:	0f50000f          	fence	iorw,ow
 ae6:	0805202f          	amoswap.w	zero,zero,(a0)
}
 aea:	6422                	ld	s0,8(sp)
