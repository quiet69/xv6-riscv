...
main(int argc, char **argv)
{
  ...
  4c:	87858593          	addi	a1,a1,-1928 # 8c0 <lock_release+0x22>
  50:	4509                	li	a0,2
...
00000000000003a2 <sched_tickets>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 402:	53a50513          	addi	a0,a0,1338 # 938 <digits>
 406:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c2:	422c8c93          	addi	s9,s9,1058 # 8e0 <lock_release+0x42>
 ...
 4d0:	46cb8b93          	addi	s7,s7,1132 # 938 <digits>
 ...
 5f6:	2e698993          	addi	s3,s3,742 # 8d8 <lock_release+0x3a>
        while(*s != 0){
 5fa:	85ee                	mv	a1,s11
...
0000000000000832 <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 848:	f08080e7          	jalr	-248(ra) # 74c <malloc>
    int t_id = clone(stack);
 84c:	00000097          	auipc	ra,0x0
 850:	b66080e7          	jalr	-1178(ra) # 3b2 <clone>
    if(t_id==0) {
 854:	c901                	beqz	a0,864 <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 86e:	a80080e7          	jalr	-1408(ra) # 2ea <exit>

0000000000000872 <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 876:	0800                	addi	s0,sp,16
    lock->locked = 0;
 878:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 87c:	6422                	ld	s0,8(sp)
 87e:	0141                	addi	sp,sp,16
 880:	8082                	ret

0000000000000882 <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 888:	4705                	li	a4,1
 88a:	87ba                	mv	a5,a4
 88c:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 890:	2781                	sext.w	a5,a5
 892:	ffe5                	bnez	a5,88a <lock_acquire+0x8>
    __sync_synchronize();
 894:	0ff0000f          	fence
}
 898:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 8a8:	0f50000f          	fence	iorw,ow
 8ac:	0805202f          	amoswap.w	zero,zero,(a0)
}
 8b0:	6422                	ld	s0,8(sp)
