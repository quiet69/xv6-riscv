...
wc(int fd, char *name)
{
  ...
  3c:	9b8a0a13          	addi	s4,s4,-1608 # 9f0 <lock_release+0x20>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	95250513          	addi	a0,a0,-1710 # a08 <lock_release+0x38>
  ...
  e8:	91450513          	addi	a0,a0,-1772 # 9f8 <lock_release+0x28>
...
main(int argc, char *argv[])
{
 ...
 162:	8ba58593          	addi	a1,a1,-1862 # a18 <lock_release+0x48>
 166:	4501                	li	a0,0
 ...
 180:	8a450513          	addi	a0,a0,-1884 # a20 <lock_release+0x50>
...
00000000000004d4 <sched_tickets>:
...
00000000000004dc <sched_statistics>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 534:	56850513          	addi	a0,a0,1384 # a98 <digits>
 538:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5f4:	450c8c93          	addi	s9,s9,1104 # a40 <lock_release+0x70>
 ...
 602:	49ab8b93          	addi	s7,s7,1178 # a98 <digits>
 ...
 728:	31498993          	addi	s3,s3,788 # a38 <lock_release+0x68>
        while(*s != 0){
 72c:	85ee                	mv	a1,s11
...
0000000000000964 <thread_create>:
#include "user/user.h"
...
thread_create(void *(start_routine)(void*), void *arg)
{
 ...
 97a:	f08080e7          	jalr	-248(ra) # 87e <malloc>
    int t_id = clone(stack);
 97e:	00000097          	auipc	ra,0x0
 982:	b66080e7          	jalr	-1178(ra) # 4e4 <clone>
    if(t_id==0) {
 986:	c901                	beqz	a0,996 <thread_create+0x32>
        (*start_routine)(arg);
        exit(0);
    }
    return 0;
 ...
 9a0:	a80080e7          	jalr	-1408(ra) # 41c <exit>

00000000000009a4 <lock_init>:
...
lock_init(struct lock_t *lock)
{
 ...
 9a8:	0800                	addi	s0,sp,16
    lock->locked = 0;
 9aa:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 9ae:	6422                	ld	s0,8(sp)
 9b0:	0141                	addi	sp,sp,16
 9b2:	8082                	ret

00000000000009b4 <lock_acquire>:
...
lock_acquire(struct lock_t *lock)
{
 ...
 9ba:	4705                	li	a4,1
 9bc:	87ba                	mv	a5,a4
 9be:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 9c2:	2781                	sext.w	a5,a5
 9c4:	ffe5                	bnez	a5,9bc <lock_acquire+0x8>
    __sync_synchronize();
 9c6:	0ff0000f          	fence
}
 9ca:	6422                	ld	s0,8(sp)
...
lock_release(struct lock_t *lock)
{
 ...
 9da:	0f50000f          	fence	iorw,ow
 9de:	0805202f          	amoswap.w	zero,zero,(a0)
}
 9e2:	6422                	ld	s0,8(sp)
