...
extern int sys_sysinfo(void);     // System Call extern for getting sys_info
extern int sys_procinfo(void);   // System Call extern for getting sys_procinfo
...
[SYS_clone]   (uint64(*)(void)) sys_clone,
};
